...
def main():
    ...
    for ensemble_dir in ensemble_dirs:
        ...
        out_path = os.path.join(ensemble_dir, "inference_benchmark_ensemble.json")
    ...
    if summary_rows:
        ...
        summary_csv = os.path.join(args.ensembles_root, "inference_benchmark_ensemble_summary.csv")
