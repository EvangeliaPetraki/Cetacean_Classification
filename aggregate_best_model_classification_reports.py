...
def main():
    ...
    parser.add_argument(
        "--report_name",
        type=str,
        default="classification_report_test.txt",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional output JSON path. Defaults to <first runs_root>/classification_report_summary.json",
    )
    parser.add_argument(
        "--out_csv",
        type=str,
        default=None,
        help="Optional output CSV path. Defaults to <first runs_root>/classification_report_summary.csv",
    )
    ...
    out_json = args.out_json or os.path.join(args.runs_root[0], "classification_report_summary.json")
    out_csv = args.out_csv or os.path.join(args.runs_root[0], "classification_report_summary.csv")
